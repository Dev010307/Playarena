...
<tr>
    ...
    <td>
                <a href="../crud/user_update.jsp?id=<%=rs.getInt("id")%>"class="btn btn-primary btn-sm">Update</a>
                <a href="../crud/users_delete.jsp?id=<%=rs.getInt("id")%>"class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete?')">Delete</a>
            </td>
</tr>
<%
    }
